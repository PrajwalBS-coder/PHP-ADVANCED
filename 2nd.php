...
<body style="background-image: url('h3.jpg');color:tomato";>
    <center>
        <form method="post" action="2nda.php">
    <table border="1" style="text-align:left">
        ...
        <tr>
            <th>Meal Selection</th><th><input type="radio" name="meal" value="Veg">Vegetarian<input type="radio" name="meal" value="Non-Veg">Non Vegetarian<input type="radio" name="meal" value="Diabetic">Diabetic<input type="radio" name="meal" value="Child">Child</th>
        </tr>       
        <tr>
